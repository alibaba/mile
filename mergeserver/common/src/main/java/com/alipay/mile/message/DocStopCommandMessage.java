 ...
 *          Exp $
 */
public class DocStopCommandMessage extends AbstractMessage {

    /** √¸¡Ó */
    private String command;
    private String docServerIp;

    public DocStopCommandMessage(){
        super();
        setType(MT_COMMON_STOP_D);
    }
    
    public DocStopCommandMessage(String docServerIp) {
        super();
        this.docServerIp = docServerIp;
        this.command = Constants.DOCSERVER_STOP;
        setType(MT_COMMON_STOP_D);
    }
