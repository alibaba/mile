 ...
 *          Exp $
 */
public class MergeStartCommandMessage extends AbstractMessage {

    /** 命令 */
    private String command;

    public MergeStartCommandMessage() {
        super();
        this.command = Constants.MERGESERVER_START;
        setType(MT_COMMON_START_M);
    }
