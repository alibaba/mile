 ...
 *          yuzhong.zhao Exp $
 */
public class MileClientCutAvgFuncTest extends MileClientAbstract {
    private static final Logger LOGGER  = Logger
                                            .getLogger(MileClientCutAvgFuncTest.class.getName());
    ...
    @Test
    public void testAvg() {
        String sql = "select avg(GMT_TEST) from TEST_DAILY";
        Object[] params = new Object[1];
        params[0] = 100L;
        ...
        assertEquals(100.0, queryResult.getQueryResult().get(0).get("AVG (GMT_TEST)"));
