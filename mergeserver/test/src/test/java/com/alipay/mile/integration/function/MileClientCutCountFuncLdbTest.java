 ...
 *          yuzhong.zhao Exp $
 */
public class MileClientCutCountFuncLdbTest extends MileClientAbstract {
    private static final Logger LOGGER  = Logger.getLogger(MileClientCutCountFuncLdbTest.class
                                            .getName());
    ...
    public void testCount() {
        String sql = "select count(n) as num from t indexwhere id =?";
        Object[] params = new Object[1];
        params[0] = "1";
        ...
        assertEquals(cut, queryResult.getQueryResult().get(0).get("num"));
