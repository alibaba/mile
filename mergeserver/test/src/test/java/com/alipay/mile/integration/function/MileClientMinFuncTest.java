 ...
 * 
 * @author yuzhong.zhao
 * @version $Id: MileClientMinFuncTest.java, v 0.1 2011-7-27 上午09:26:35 yuzhong.zhao Exp $
 */
public class MileClientMinFuncTest extends MileClientAbstract {
    private static final Logger LOGGER  = Logger.getLogger(MileClientMinFuncTest.class.getName());
    ...
    public void setUp() {
        ...
        // 插入数据
        String sql = "insert into TEST_DAILY TEST_ID=? TEST_IP=? TEST_IP=? GMT_TEST=?";
