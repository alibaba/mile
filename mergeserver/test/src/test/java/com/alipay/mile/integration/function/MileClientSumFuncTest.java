 ...
 * 
 * @author yuzhong.zhao
 * @version $Id: MileClientSumFuncTest.java, v 0.1 2011-7-27 上午09:28:04 yuzhong.zhao Exp $
 */
public class MileClientSumFuncTest extends MileClientAbstract {
    private static final Logger LOGGER  = Logger.getLogger(MileClientSumFuncTest.class.getName());
