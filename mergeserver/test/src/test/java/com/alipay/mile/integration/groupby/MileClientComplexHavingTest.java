 ...
 *
 * @author yuzhong.zhao
 * @version $Id: MileClientComplexHavingTest.java, v 0.1 2011-7-27 上午11:07:48 yuzhong.zhao Exp $
 */
public class MileClientComplexHavingTest extends MileClientAbstract {
    private static final Logger LOGGER  = Logger.getLogger(MileClientComplexHavingTest.class
                                            .getName());
    //超时
    ...
    public void testComplexHavingGroupby() {
        try {
