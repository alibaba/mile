 ...
 *
 * @author yuzhong.zhao
 * @version $Id: MileClientDescOrderTest.java, v 0.1 2011-7-27 上午11:11:09 yuzhong.zhao Exp $
 */
public class MileClientDescOrderTest extends MileClientAbstract {
    private static final Logger LOGGER  = Logger.getLogger(MileClientDescOrderTest.class.getName());
    //超时
    ...
    public void testDescOrderby() {
        try {
            ...
            for (int i = 0; i < 100; i++) {
                ...
                assertEquals(Long.valueOf(99 - i), record.get("GMT_TEST"));
            }
        } catch (Exception e) {
            assertTrue(false);
        }
