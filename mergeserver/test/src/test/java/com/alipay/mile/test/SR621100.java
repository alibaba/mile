...
/**
 * @author xiaoju.luo
 * @version $Id: SR621100.java,v 0.1 2012-11-6 下午03:50:08 xiaoju.luo Exp $
 */
@RunWith(SpecRunner.class)
@Feature("聚合函数与group by，limit")
public class SR621100 extends DocdbTestTools {
    int timeOut = 5000;
