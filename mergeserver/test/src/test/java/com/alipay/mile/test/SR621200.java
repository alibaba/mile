...
/**
 * @author xiaoju.luo
 * @version $Id: SR621200.java,v 0.1 2012-11-16 下午05:49:57 xiaoju.luo Exp $
 */
@RunWith(SpecRunner.class)
@Feature("null的聚合函数统计")
public class SR621200 extends DocdbTestTools {
    int timeOut = 5000;
    ...
    @Test
    @Subject("聚合函数，平方和且有别名查询，统计null列")
    @Priority(PriorityLevel.HIGHEST)
    @Tester("xiaoju.luo")
    ...
    @Test
    @Subject("聚合函数,标准差且有别名查询,统计null列")
    @Priority(PriorityLevel.HIGHEST)
    @Tester("xiaoju.luo")
    ...
    @Test
    @Subject("聚合函数,所有聚合函数支持且有别名查询,统计null列")
    @Priority(PriorityLevel.HIGHEST)
    @Tester("xiaoju.luo")
    ...
    @Test
    @Subject("聚合函数,平均数且有别名查询,统计null列")
    @Priority(PriorityLevel.HIGHEST)
    @Tester("xiaoju.luo")
    ...
    @Test
    @Subject("聚合函数，count且带别名，统计null列")
    @Priority(PriorityLevel.HIGHEST)
    @Tester("xiaoju.luo")
    ...
    @Test
    @Subject("聚合函数，count(distinct)且带别名,统计null列")
    @Priority(PriorityLevel.HIGHEST)
    @Tester("xiaoju.luo")
