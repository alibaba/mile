...
/**
 * @author xiaoju.luo
 * @version $Id: SR621210.java,v 0.1 2012-11-16 下午05:58:01 xiaoju.luo Exp $
 */
...
public class SR621210 extends DocdbTestTools {
    ...
    @Test
    @Subject("聚合函数，count(distinct)且带别名,统计字符串列")
    @Priority(PriorityLevel.HIGHEST)
    @Tester("xiaoju.luo")
    ...
    @Test
    @Subject("聚合函数,所有聚合函数支持且有别名查询,统计字符串列")
    @Priority(PriorityLevel.HIGHEST)
    @Tester("xiaoju.luo")
